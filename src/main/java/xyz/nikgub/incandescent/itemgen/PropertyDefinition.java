 ...
 * @param mutator      {@link PropertyMutator} enacted during item generation
 ...
 */
public record PropertyDefinition<FT, TT>(@NotNull Class<TT> clazz, @NotNull PropertyMutator<TT> mutator,
                                         @Nullable TT defaultValue, @Nullable Converter<FT, TT> converter)
{
    @NotNull
